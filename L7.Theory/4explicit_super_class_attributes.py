...
def main():
    print('Base:')
    print('class attribute:',Base.attr)
    base_instance = Base()
    base_instance.method()
    print('object attribute:',base_instance.attr )

    print()

    print('Child:')
    print('Class Child attribute:',Child.attr)
    print('SuperClass attribute:',Child.get_superclass_attr())
    child_instance = Child()
    child_instance.method()
    print('object attribute:', child_instance.attr)
